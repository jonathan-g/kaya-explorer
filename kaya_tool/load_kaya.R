...
load_kaya <- function() {
  ...
  pop_file = file.path("data", "API_SP.POP.TOTL_DS2_en_csv_v2.csv")
  # Data from World Bank
  # https://data.worldbank.org/indicator/NY.GDP.MKTP.KD
  # GDP constant 2010 US dollars
  # Because PPP adjusted GDP is not available before 1990
  gdp_file = file.path("data", "API_NY.GDP.MKTP.KD_DS2_en_csv_v2.csv")
  # Data from BP Statistical Review of World Energy
  # https://www.bp.com/en/global/corporate/energy-economics/statistical-review-of-world-energy/downloads.html
  energy_file = file.path("data", "bp-statistical-review-of-world-energy-2017-underpinning-data.xlsx")
