...
load_energy_by_fuel <- function() {
  ...
  coal_filename = 'data/World_coal_consumption_by_region.csv'
  oil_filename <- 'data/World_liquids_consumption_by_region.csv'
  gas_filename <- 'data/World_natural_gas_consumption_by_region.csv'
