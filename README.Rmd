...
**GitLab:** [![Build Status](https://gitlab.jgilligan.org/gilligan_teaching/ees_3310/ees_3310_software/kaya-explorer/badges/main/pipeline.svg)](https://gitlab.jgilligan.org/gilligan_teaching/ees_3310/ees_3310_software/kaya-explorer/commits/main)
<!-- badges: end -->
...
This interactive application was inspired by Roger Pielke’s book, [_The Climate
Fix_](https://books.google.com/books/about/The_Climate_Fix.html?id=WgcCoYsR41IC)
and the app closely follows the analysis presented in chapters 3--4 of that 
book.
...
Conduct](https://jonathan-g.github.io/kaya-explorer/CODE_OF_CONDUCT.html). By
