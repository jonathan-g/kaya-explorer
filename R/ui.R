...
ui <- shiny::fluidPage(
  ...
  shiny::sidebarLayout(
    ...
    shiny::mainPanel(
      shiny::tabsetPanel(id = "tabs", type="tabs",
                  shiny::tabPanel("Trends",
                           ...
                           shiny::fluidRow(
                             shiny::column(6,
                                    shiny::span(h4(strong(shiny::textOutput('trend_plot_ln_title'))),
                             ...
                             shiny::column(6,
                                    shiny::span(h4(strong(shiny::textOutput('trend_plot_title'))),
                                         style="text-align:center;"),
                                    shiny::div(
                  ...
                  shiny::tabPanel("Calculations",
                           ...
                           {
                             if (enable_answers) {
                               shiny::checkboxInput('calc_show_answers', "Show answers", value = FALSE)
                             } else {
                               shiny::HTML("")
                             }
                           },
